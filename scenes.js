...
// A second compositing pass sits beneath and above every bespoke scene. It is
// deliberately mapped by individual milestone (rather than by era alone), so
// the atmosphere supports the source image: water has reflected motion, war
// has distant smoke and light, manuscripts have warm paper light, and so on.
export const sceneTreatments = Object.freeze({
  big_bang: "cosmic",
  earth_formation: "cosmic",
  first_life: "ocean",
  cambrian: "ocean",
  great_dying: "eruption",
  dinosaurs: "eruption",
  mammals: "wild",
  lucy: "wild",
  ice_age: "winter",
  ...
  mongols: "conflict",
  black_death: "somber",
  printing_press: "archive",
  constantinople: "fire",
  columbus: "ocean",
  pirates: "ocean",
  king_tut: "desert",
  scientific_rev: "industry",
  industrial: "industry",
  revolution: "industry",
  vaccine: "industry",
  telephone: "industry",
  ...
  smallpox: "somber",
  challenger: "cosmic",
  berlin_wall: "liberation",
  internet: "tech",
  dotcom_bubble: "market",
  sept_11: "somber",
  smartphone: "tech",
  financial_crash: "market",
  mars_rover: "cosmic",
  trillion_dollar_company: "market",
  covid: "somber",
  ukraine: "conflict",
  hormuz: "maritime",
});
